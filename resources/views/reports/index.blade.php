    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-amber-100 overflow-hidden">
                    <div class="px-6 py-4 bg-gradient-to-r from-amber-500 to-orange-600">
                        <div class="flex items-center gap-3 text-white">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-amber-100">Distribución de pagos</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-6">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-emerald-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-600">
                    <div class="flex items-center gap-3 text-white">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-emerald-100">Ranking de productos</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-violet-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-violet-600 to-purple-700">
                    <div class="flex items-center gap-3 text-white">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-violet-100">Selecciona el rango de fechas</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-rose-100 overflow-hidden">
                    <div class="px-6 py-4 bg-gradient-to-r from-rose-500 to-pink-600">
                        <div class="flex items-center gap-3 text-white">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-rose-100">Top productos por cantidad</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-6">
                        @if($productosVendidos->count() > 0)
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y-2 divide-rose-100">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50 transition-all duration-200">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg font-bold text-xs text-white bg-gradient-to-r from-rose-500 to-pink-600 shadow-md">
                                            ...
                                            <td class="px-4 py-3 text-sm font-black text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-pink-600">
                        ...
                        @else
                            <div class="text-center py-8">
                                <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-rose-100 to-pink-100 rounded-full flex items-center justify-center">
                ...
                <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border-2 border-cyan-100 overflow-hidden">
                    <div class="px-6 py-4 bg-gradient-to-r from-cyan-500 to-sky-600">
                        <div class="flex items-center gap-3 text-white">
                            <div class="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-cyan-100">Rendimiento del equipo</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-6">
                        @if($ventasPorUsuario->count() > 0)
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y-2 divide-cyan-100">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gradient-to-r hover:from-cyan-50 hover:to-sky-50 transition-all duration-200">
                                            <td class="px-4 py-3 text-sm">
                                                <div class="flex items-center gap-2">
                                                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-sky-600 flex items-center justify-center text-white font-bold text-xs shadow-md">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <span class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg font-bold text-xs text-white bg-gradient-to-r from-cyan-500 to-sky-600 shadow-md">
                                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                    </svg>
                                            ...
                                            <td class="px-4 py-3 text-sm font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-sky-600">
                        ...
                        @else
                            <div class="text-center py-8">
                                <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-cyan-100 to-sky-100 rounded-full flex items-center justify-center">
