        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-4 mb-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900">Editar Empresa</h2>
                </div>
                <p class="text-sm text-gray-600">Modifica los datos de la empresa {{ $empresa->nombre }}</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="moneda" 
                                ...
                                <option value="USD" {{ old('moneda', $empresa->moneda) == 'USD' ? 'selected' : '' }}>USD - Dólar Americano</option>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="iva_porcentaje" 
                                   id="iva_porcentaje" 
                                   value="{{ old('iva_porcentaje', $empresa->iva_porcentaje) }}"
                                   step="0.01"
                                   min="0"
                                   max="100"
                                   required
